...
export class Mailer {
  ...
  welcome = async (opts: { to: string, teamUrl: string }) => {
    this.sendMail({
      to: opts.to,
      title: 'Welcome to QuezX Documentation',
      previewText:
        'QuezX Documentation is a place for your team to build and share knowledge.',
  ...
  export = async (opts: { to: string, attachments: Object[] }) => {
    this.sendMail({
      ...
      previewText: "Here's your request data export from QuezX Documentation",
      html: <ExportEmail />,
  ...
  signin = async (opts: { to: string, token: string, teamUrl: string }) => {
    this.sendMail({
      ...
      previewText: 'Here’s your link to signin to QuezX Documentation.',
